...
-(void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations
{
    ...
    MKCoordinateRegion region = MKCoordinateRegionMake(coordinate, MKCoordinateSpanMake(1.2, 1.2));
...
-(MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id<MKAnnotation>)annotation{
    ...
    if (!view)
    {
        ...
        [view setEnabled:YES];
        [view setImage:[UIImage resizableImage:@"ic_map_recommend_pressed" andSize:CGSizeMake(30, 30)]];
